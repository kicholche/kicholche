...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="bn" suppressHydrationWarning><body><AnalyticsTracker/><LanguageSwitcher/>{children}</body></html>}
